...
If your laptop passes [the three checks described here](./will_this_patch_work_on_other_laptops.md), open an issue by collecting the required diagnostics using the steps below and the [new device issue template](https://github.com/marco-giunta/legion-pro7-gen10-audio/issues/new?template=new_device.yml).
